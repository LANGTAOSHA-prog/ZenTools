window.ZT_COMMON = {
  ...
  en: {
    ...
    navContact: 'Contact',
    navPrivacy: 'Privacy',
    navGuides: 'Deep Guides',
    navCompare: 'Compare',
    navProfessions: 'By Profession',
    navMy: 'My Space',
    navFAQ: 'FAQ',
    footerCopy: '© 2026 ZenTools. Free online toolbox, continuously updated.',
    searchPlaceholder: 'Search tools, e.g. PDF, image compress, AI writing...',
    breadcrumbHome: 'Home',
    langZh: 'Chinese',
    langEn: 'English',
    langJa: 'Japanese',
  ...
  vi: {
    navHome: 'Trang chủ',
    navTools: 'Công cụ',
    navAll: 'Tất cả công cụ',
    navPdf: 'Công cụ PDF',
    navArticles: 'Hướng dẫn',
    ...
    navCompare: 'So sánh',
    navProfessions: 'Theo Nghề',
    navMy: 'Trang cá nhân',
    navFAQ: 'FAQ',
    footerCopy: '© 2026 ZenTools. Hộp công cụ trực tuyến miễn phí, liên tục cập nhật.',
    searchPlaceholder: 'Tìm công cụ, vd: PDF, nén ảnh, AI viết...',
